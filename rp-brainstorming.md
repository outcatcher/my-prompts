...
## Lorebook Optimization Notes
When reviewing RP materials, explicitly mark elements that should be moved out of the main prompt and into lorebook storage. Use clear labels such as:

- **Lorebook Candidate – Side character info, rarely used.**
- **Lorebook Candidate – Detailed worldbuilding, not essential for every message.**
- **Lorebook Candidate – Long backstory; keep as triggered memory.**
